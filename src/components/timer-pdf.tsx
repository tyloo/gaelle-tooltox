...
const TimerPDFContent = ({ groupedSessions }: TimerPDFProps) => {
  const invoiceNumber = `INV-${new Date().getFullYear()}-${String(new Date().getMonth() + 1).padStart(2, '0')}-${String(
      ...
      <Page size='A4' style={styles.page}>
        <View style={styles.header}>
          <View style={styles.companyInfo}>
            ...
            <Text style={styles.companyDetails}>contact.gcoquard@gmail.com</Text>
          </View>
        ...
        <View style={styles.clientInfo}>
          ...
          <Text style={styles.companyDetails}>10 Rue DE L&apos;ECOLE GRAND CERISEAUX</Text>
            ...
            return (
              <View key={type} style={styles.section}>
                ...
                <View style={styles.sessionItem}>
                  <Text style={styles.text}>Durée: {formatHoursAndQuarters(roundedDuration)}</Text>
        ...
        <View style={styles.summary}>
          ...
          <View style={styles.summaryRow}>
            ...
            <Text style={styles.summaryValue}>{(subtotal * VAT_RATE).toFixed(2)}€</Text>
          </View>
          <View style={styles.summaryRow}>
            <Text style={[styles.summaryLabel, styles.grandTotal]}>Total TTC</Text>
            <Text style={[styles.summaryValue, styles.grandTotal]}>{(subtotal * (1 + VAT_RATE)).toFixed(2)}€</Text>
          </View>
        </View>

        <View style={styles.footer}>
          <Text>Merci de votre confiance. Pour toute question, n&apos;hésitez pas à nous contacter.</Text>
        </View>
      </Page>
    </Document>
  )
...
export const TimerPDF = ({ groupedSessions, formatTime }: TimerPDFProps) => (
  <PDFDownloadLink
    document={<TimerPDFContent groupedSessions={groupedSessions} formatTime={formatTime} />}
